  ...
  <div class="container">
    ...
    <div class="row">
      <table class="table table-striped table-bordered">
        ...
        <tbody>
          <tr v-for="(upload, index) in uploadedFiles" :key="upload.id" :class="upload.id">
            ...
            <td>
              <div class="form-group">
                <select v-model="upload.datatype" :name="`Upload[${upload.id}][datatype]`"
                  ...
                  <option v-for="datatype in dataTypes" :key="datatype" :class="datatype">{{ datatype }}</option>
                </select>
              </div>
            </td>
    ...
    <input v-for="(uploadId, index) in filesToDelete" :key="`${uploadId}-files-to-delete`" type="hidden" :name="`DeleteList[${index}]`"
      :value="uploadId" :class="uploadId" />

    <div v-for="(attributes, uid) in fileAttributes" :key="`${uid}-file-attrs`">
      <div v-for="(attr, idx) in attributes" :key="`${idx}-file-attr`" :class="idx">
